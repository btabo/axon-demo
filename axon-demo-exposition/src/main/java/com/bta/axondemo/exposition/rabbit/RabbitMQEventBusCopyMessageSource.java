...
@Profile("rabbitmq")
public class RabbitMQEventBusCopyMessageSource extends SpringAMQPMessageSource {

    @Autowired
    public RabbitMQEventBusCopyMessageSource(final AMQPMessageConverter messageConverter) {
